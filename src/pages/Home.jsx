            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 ">
                <div className="grid items-center grid-cols-1 lg:grid-cols-2 gap-x-12 xl:gap-x-24 gap-y-12">
                    ...
                    <div  className="2xl:pl-16">
                        ...
                        <motion.p variants={fadeInVarients} className="mt-6 text-xl leading-relaxed text-gray-900 dark:text-gray-300">Learn more about me <NavLink to = '/about' className='text-blue-500 underline'>here  </NavLink></motion.p>
                    </div>
                </div>
            </div>
        </section>
