...
const resumeLink = "https://docs.google.com/document/d/1LlG_DJXBvQdlwcSjVaEgNiNFmyMj2bnd6PfRmma9fdI/edit?usp=sharing"
const NavBar = () => {
        ...
        <nav className={"bg-white dark:bg-gray-950 fixed w-full z-20  top-0 left-0 transition-colors duration-500 " +( scrolled ? "shadow-lg" : "")}>
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 lg:grid lg:grid-cols-3 lg:py-2">
                ...
                <div className="flex lg:order-2 items-stretch  space-x-2 lg:justify-end">
                    <DarkModeToggle />
                    <a href = {resumeLink} target = "_blank" type="button" className="flex items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 lg:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
